...
hazard_keywords <- tribble(
  ...
  "Drought", "drought, drought cycle, prolonged droughts, drougths, dry spell, dry days, ardity",
...
haz_patterns <- list(
  ...
  "Drought" = paste(
    "drought", "drought cycle", "prolonged droughts","drougths","dry spell","dry days","ardity", sep = "|"
  ),
